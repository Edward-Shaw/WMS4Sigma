  ...
  <div class="container-fluid">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        <li><a href="<c:url value="/admin" />">样机管理</a></li>
        <li><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">历史数据<span class="caret"></span></a>
        	<ul class="dropdown-menu" role="menu">
               <li><a href="<c:url value="/admin/log" />">样机变更历史查询</a></li>
               <li><a href="<c:url value="/admin/current-rent" />">当前出借样机</a></li>
               <li><a href="<c:url value="/admin/rent-log" />">样机出借历史查询</a></li>
             </ul>
        </li>
      </ul>
      
      <ul class="nav navbar-nav navbar-right">
         <li><a href="<c:url value="/users/manage" />">员工管理</a></li>
